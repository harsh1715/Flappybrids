...
class Bird:
    def __init__(self, x, y):
        ...
        self.y = y
        self.velocity_y = 0
        self.acceleration_y = 0.2  # Adjusted to maintain similar behavior
        self.friction = 0.99  # Adjusted to maintain similar behavior
        self.radius = BIRD_SIZE // 2

    def flap(self):
        self.velocity_y = -FLAP_STRENGTH  # Flap resets velocity
